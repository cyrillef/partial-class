...
export function PartialMixins(name: string | symbol): Function;
export function PartialMixins(target: Function): void;
export function PartialMixins(...args: any[]): Function | void {
...
export function FinalMixins<T extends ClassDefinition>(constructor: T): T {
